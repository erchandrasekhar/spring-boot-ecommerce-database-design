...
<c:if test="${saveSuccess == null}">
 <h5><strong>Devganga Logestic Bill Genration Form</strong> </h5>
  ...
  <div class="col-md-4">
    ...
    <label class="control-label" for="generatedBy">Bill Generated By&nbsp;<font size="3" color="red">*</font></label>
      <input type="text" name="generatedBy" id="generatedBy" value="${loginUser.firstName} &nbsp;${loginUser.lastName}"  class="form-control" placeholder="Name of bill Genrated Persion" readonly="readonly">          
       <input type="hidden" name="userId" id="userId" value="${loginUser.userId}"  class="form-control">          
  </div>
  </div>
 ...
 <div class="col-md-4">
  ...
  <div class="col-md-4">
    <div class="form-group">
    <label class="control-label" for="totalPrice">Total Price&nbsp;<font size="3" color="red">*</font>&nbsp;<a onclick="calulateTotal();">View Total Amount</a></label>
