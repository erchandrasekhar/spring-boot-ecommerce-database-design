...
<div class="col-sm-4">
                               <c:if test="${newUser != null }">
							    ...
							    <strong>Success!</strong> Password Changed successfully <br>
							   <strong> UserName=${newUser.userName} </strong><br>
								...
								<a href="profile" class="active" id="login-form-link" style="text-align:center;font-size: 20px;">Change Password</a>
							
						
								
								<form id="profile" action="changePassword" method="post" style="padding: 10px;">
									<div class="form-group">
									<label> First Name</label>
									    <input type="hidden" id="id" name="id" value="${loginUser.userId}">
										<input type="text" name="firstName" id="firstName" value="${loginUser.firstName }" tabindex="1" class="form-control" placeholder="Enter First Name" readonly>
									</div>
									<div class="form-group">
										<label> Old Password</label>
										<input type="text" name="oldPassword" id="oldPassword" value="${loginUser.password }" tabindex="1" class="form-control" placeholder="Old Password" readonly>
									</div>
									<div class="form-group">
										<label> New Password</label>
										<input type="password" name="password" id="password" value="" tabindex="2" class="form-control" placeholder="Enter New Password">
									</div>
