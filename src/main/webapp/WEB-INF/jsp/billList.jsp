...
<c:if test="${updateSuccess == true }">
 ...
 <h5><strong>Devganga Logestic Genrated Bill Number&nbsp;(${dlBill.dlBillId}) and Generation Date &nbsp;${dlBill.billDate}</strong> </h5>
  ...
  <div class="col-md-4">
    ...
    <label class="control-label" for="generatedBy">Bill Generated By&nbsp;<font size="3" color="red">*</font></label>
      <input type="text" name="generatedBy" id="generatedBy" value="${dlBill.user.firstName}" class="form-control" placeholder="" readonly="readonly">          
 ...
 <h5><strong>Devganga Logestic Genrated Bill Number&nbsp;(${dlBill.dlBillId}) and Generation Date &nbsp;${dlBill.billDate}</strong> </h5>
  ...
  <div class="col-md-4">
    <div class="form-group">
    <label class="control-label" for="generatedBy">Bill Generated By&nbsp;<font size="3" color="red">*</font></label>
      <input type="text" name="generatedBy" id="generatedBy" value="${dlBill.user.firstName} &nbsp;${dlBill.user.lastName}" class="form-control" readonly="readonly">          
